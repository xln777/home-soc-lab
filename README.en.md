...
A small self-hosted SOC lab built around the Cowrie SSH honeypot. The project combines real-world honeypot logs, Python-based reporting, threat-intelligence enrichment and short incident writeups.
